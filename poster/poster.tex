...
\begin{minipage}[t]{0.45\textwidth}
    ...
    %In sessile oak, vessel area was measured and several related xylem metrics were derived (Fig. \ref{fig:oak_box}). In Norway spruce, radial cell wall thinkness and radial tracheid diameter were measured in three radial cell files, and were analyzed separately for early- and latewood (Fig. \ref{fig:spruce_box}).
...
\begin{block}{Results}
\heading{Sessile oak}
Sessile oak appeared to be very responsive to drought treatments.
...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{\colorbox{red!30}{red fill}} -- dry (wet) variant with treatment. Sign. difference from dry (wet) variant without treatment;
...
\begin{figure}
    ...
    \caption{
        ...
        \textbf{\colorbox{darkgray!30}{Dark grey fill}} -- dry (wet) variant without treatment;
        \textbf{\colorbox{gray!15}{light grey fill}} -- dry (wet) variant with treatment. No sig. difference from dry (wet) variant without treatment;
        %\textbf{\textcolor{red}{red fill}} -- dry (wet) variant with treatment. Sign. difference from dry (wet) variant without treatment;
        \textbf{\textcolor{black}{black outline}} -- treatment of dry (wet) variant \emph{is not} sig. different from (wet) variant of the same treatment;
        \textbf{\textcolor{blue}{blue outline}} -- treatment of dry (wet) variant \emph{is} sig. different from (wet) variant of the same treatment.
        $\alpha = 0.1$
    }
